...
const ages = [22, 14, 24, 55, 65, 21, 12, 13, 90];
let parValue = ages.filter((element) => element % 2 === 0);
...
let newStreamer = streamers.filter((element) => {
...
let uStreamers = streamers.filter(function(name){
...
const lgStreamers = streamers.filter((element) => {
